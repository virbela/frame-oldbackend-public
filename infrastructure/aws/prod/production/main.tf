...
###
## Hong Kong region (ingress, egress)
###
module "hongkong_common" {
  source = "../../modules/common"
...
module "hongkong_region" {
  ...
  fargate_manage_task    = module.primary_base.fargate_manage_task
  arn_taskexecution_name = var.arn_taskexecution_name
  vpc                    = module.hongkong_common.vpc
  vpc_cidr               = module.primary_common.vpc_cidr
  aws_account_id         = module.primary_base.aws_account_id
  ingress_image_path     = var.ingress_image_path
  egress_image_path      = var.egress_image_path
  ...
  ecs_cluster = module.hongkong_common.ecs_cluster

  sn_public  = module.hongkong_common.sn_public
  sn_private = module.hongkong_common.sn_private
...
###
## Sao Paulo region (ingress, egress)
###
module "saopaulo_common" {
  source = "../../modules/common"
...
module "saopaulo_region" {
  ...
  fargate_manage_task    = module.primary_base.fargate_manage_task
  arn_taskexecution_name = var.arn_taskexecution_name
  vpc                    = module.saopaulo_common.vpc
  vpc_cidr               = module.primary_common.vpc_cidr
  aws_account_id         = module.primary_base.aws_account_id
  ingress_image_path     = var.ingress_image_path
  egress_image_path      = var.egress_image_path
  ...
  ecs_cluster = module.saopaulo_common.ecs_cluster

  sn_public  = module.saopaulo_common.sn_public
  sn_private = module.saopaulo_common.sn_private
...
###
## Singapore region (ingress, egress)
###
module "singapore_common" {
  source = "../../modules/common"
...
module "singapore_region" {
  ...
  fargate_manage_task    = module.primary_base.fargate_manage_task
  arn_taskexecution_name = var.arn_taskexecution_name
  vpc                    = module.singapore_common.vpc
  vpc_cidr               = module.primary_common.vpc_cidr
  aws_account_id         = module.primary_base.aws_account_id
  ingress_image_path     = var.ingress_image_path
  egress_image_path      = var.egress_image_path
  ...
  ecs_cluster = module.singapore_common.ecs_cluster

  sn_public  = module.singapore_common.sn_public
  sn_private = module.singapore_common.sn_private
...
module "tokyo_region" {
  ...
  ecs_cluster = module.tokyo_common.ecs_cluster

  sn_public  = module.tokyo_common.sn_public
  sn_private = module.tokyo_common.sn_private
